...
def calcularPorcentaje():
    ...
    print(f"El porcentaje de personas que faltaron por Enfermedad fue de...           {round((Enfermedad['total']*100)/total,2) if Enfermedad['total'] > 0 else 0}%")
    print(f"El porcentaje de personas que faltaron por Causas Personales fue de...    {round((Causas_Personales['total']*100)/total,2) if Causas_Personales['total'] > 0 else 0}%")
    print(f"El porcentaje de personas que faltaron por Licencia Gremial fue de...     {round((Licencia_Gremial['total']*100)/total, 2) if Licencia_Gremial['total'] > 0 else 0}%")
